package com.oguzhanp.chess.debug
...
import com.oguzhanp.chess.EngineUiState
import com.oguzhanp.chess.EngineViewModel
...
// ============================================================
//  Motor dogrulama ekrani -- GECICI
// ============================================================
// Faz 2.4'te motorun coroutine sarmalayicisini sinamak icin yazildi.
// Faz 3'te tahta, Faz 5'te navigasyon gelince bu ekran KALDIRILACAK.
// debug paketinde durmasinin sebebi bu: urun kodu degil.
...
//
// Yapi: App() ViewModel'i baglar, EngineTestContent() yalnizca aldigini cizer.
...
@Composable
private fun EngineTestContentIdlePreview() {
    ChessTheme {
        EngineTestContent(
            state = PREVIEW_STATE,
...
@Preview(showBackground = true)
@Composable
private fun EngineTestContentSearchingPreview() {
    ChessTheme {
        EngineTestContent(
